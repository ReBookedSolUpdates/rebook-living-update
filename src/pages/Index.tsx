  ...
  return (
    <Layout>
      ...
      <section className="relative h-[65vh] md:h-[72vh]">
        <img
          src="https://images.pexels.com/photos/34825996/pexels-photo-34825996.jpeg"
          alt="Academic building with modern accommodation facilities for university students"
